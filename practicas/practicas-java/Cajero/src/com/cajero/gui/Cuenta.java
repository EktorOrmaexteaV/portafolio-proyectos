...
public class Cuenta {
	...
	/**
	 * Inicia la interfaz gráfica de la cuenta del usuario.
	 */
	private void iniciar() {
		...
		lblUsuario.setBounds(60, 89, 296, 28);
		...
		btnReporte.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new Reporte(cuenta);
				//new VentanaReporte(cuenta); bolivia
			}
		});
	...
	/**
	 * Muestra un diálogo de confirmación para volver al Main().
	 */
	private void confirmarSalida() {
		int respuesta = JOptionPane.showConfirmDialog(frmCuenta, "¿"
				+ "Desea volver a la ventana principal"
				+ "?", 
				"Confirmar salida",
				JOptionPane.YES_NO_OPTION);
		if (respuesta == JOptionPane.YES_OPTION) {
			frmCuenta.dispose(); // Cierra la ventana actual
			new Main(); // Retorna a la ventana principal		
		}
	}
	
	/**
	 * Muestra un diálogo para pedir el PIN al usuario.
	 * @param mensaje El mensaje que se mostrará en el diálogo.
	 * @return El PIN ingresado por el usuario, o null si se cancela.
	 */
	...
	/**
	 * Método para depositar saldo en la cuenta del usuario.
	 * Solicita al usuario la cantidad a depositar y actualiza el saldo.
	 */
	...
	/**
	 * Método para retirar saldo de la cuenta del usuario.
	 * Solicita al usuario la cantidad a retirar y actualiza el saldo.
	 */
	...
	/**
	 * Método para cambiar el PIN de la cuenta del usuario.
	 * Solicita al usuario el PIN actual, el nuevo PIN y su confirmación.
	 */
